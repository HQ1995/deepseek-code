...
| `turn-notices` | Pure: xAI turn notices from native events and stream chunks (retry and typed failure states, tool calls being written, automatic compaction, plan mode, turn triggers) |
