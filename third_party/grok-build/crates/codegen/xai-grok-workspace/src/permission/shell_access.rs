    ...
    pub fn description(self) -> Option<&'static str> {
        match self {
            ...
            Self::GrokConfig => Some(
                "Note: This edit contains changes to Dscode config, which can alter permissions, tools, and other behavior in later sessions.",
            ),
            Self::GrokSandbox => Some(
                "Note: This edit contains changes to the Dscode sandbox config, which can loosen filesystem and network restrictions on commands.",
            ),
