...
pub enum Action {
    ...
    /// Record the bundle persona the user picked as the next session's
    /// agentProfile (resolved to a dsh agent preset by the harness leader).
    SelectPersona(String),
    /// Toggle the bundled persona/role/agent catalog pane (Ctrl+Y or /preset).
    ToggleCatalog,
