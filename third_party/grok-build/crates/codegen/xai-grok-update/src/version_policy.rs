...
pub(crate) enum VersionPolicyError {
    #[error(
        "Cannot install Dscode {target}: the minimum allowed version is {minimum}. \
         Run `dscode update` to install the latest allowed version."
    )]
