...
impl AgentDefinition {
    ...
    pub fn default_grok_build() -> Self {
        Self::base(
            ...
            "Deepseek Code agent for software engineering tasks.",
        )
    }
    ...
    pub fn grok_build_concise() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Deepseek Code agent with concise output format.",
            )
        }
    }
    ...
    pub fn grok_build_plan() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Deepseek Code agent with plan mode support.",
            )
        }
    }
    ...
    pub fn grok_build_plan_no_subagents() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Deepseek Code agent with plan mode (no subagents).",
            )
        }
    }
    ...
    pub fn grok_build_ask_user() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Deepseek Code agent with ask-user-question tool.",
            )
        }
    }
    pub fn codex() -> Self {
